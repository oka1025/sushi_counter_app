...
ActiveRecord::Schema[7.0].define(version: 2025_07_30_071438) do
  ...
  create_table "bookmarks", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["sushi_item_id"], name: "index_bookmarks_on_sushi_item_id"
    t.index ["user_id", "sushi_item_id"], name: "index_bookmarks_on_user_id_and_sushi_item_id", unique: true
  ...
  create_table "user_sushi_item_images", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["user_id", "sushi_item_id"], name: "index_user_sushi_item_images_on_user_id_and_sushi_item_id", unique: true
  ...
  add_foreign_key "bookmarks", "sushi_items"
