...
attach_image(name: "赤貝", filename: "akagai.png")
attach_image(name: "コーン", filename: "corn.png")
attach_image(name: "いくら", filename: "ikura.png")
attach_image(name: "いわし", filename: "iwasi.png")
attach_image(name: "オニオンサーモン", filename: "onionsalmon.png")
# 他の寿司も必要に応じて追加
